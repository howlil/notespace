...
- Versioned full-library ZIP backup and transactional restore covering Categories, active Workspaces, Workspace Plans, standalone tasks, Trash, images, study sessions, and legacy history data when present.
