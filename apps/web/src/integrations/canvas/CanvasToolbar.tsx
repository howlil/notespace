...
function CanvasColorControl({ api }: { api: ExcalidrawImperativeAPI | null }) {
  ...
  return (
    <div ref={triggerRef} className="relative flex shrink-0">
      ...
      {open && <div ref={panelRef} role="dialog" className="absolute top-0 left-full z-20 ml-2 w-[176px] rounded-lg border border-line bg-surface p-2 text-ink shadow-[0_12px_32px_#0002]" aria-label="Canvas colors" onPointerDown={(event) => event.stopPropagation()}>
