...
// IndexedWorkspaceStore keeps authored SQLite rows authoritative. Search has its
...
type IndexedWorkspaceStore struct{ *Store }

func NewIndexedWorkspaceStore(store *Store) *IndexedWorkspaceStore {
	return &IndexedWorkspaceStore{Store: store}
}

func (s *IndexedWorkspaceStore) refresh(ctx context.Context, workspaceID string) {
...
func (s *IndexedWorkspaceStore) Create(ctx context.Context, value workspace.Workspace) error {
...
func (s *IndexedWorkspaceStore) Update(ctx context.Context, id string, update workspace.Update) (workspace.Workspace, error) {
...
func (s *IndexedWorkspaceStore) CreateNote(ctx context.Context, workspaceID string, input workspace.NoteCreate) (workspace.Note, error) {
...
func (s *IndexedWorkspaceStore) UpdateNote(ctx context.Context, workspaceID, noteID string, update workspace.NoteUpdate) (workspace.Note, error) {
...
func (s *IndexedWorkspaceStore) DeleteNote(ctx context.Context, workspaceID, noteID string, version int) error {
...
func (s *IndexedWorkspaceStore) Move(ctx context.Context, id, categoryID string) (workspace.Workspace, error) {
...
func (s *IndexedWorkspaceStore) Search(ctx context.Context, query string) ([]workspace.SearchResult, error) {
