...
export function ActivityDock() {
  ...
  if (activity.handoffResolving) {
    return (
      <section className={dockClass} role="status" aria-label="Activity task handoff">
        <div className="flex min-h-8 items-center gap-2 text-[11px] text-muted">
  ...
  if (activity.handoffTask) {
    return (
      <section className={dockClass} role="status" aria-label="Task completion handoff">
  ...
  return (
    <section className={dockClass} role="status" aria-label="Active activity">
